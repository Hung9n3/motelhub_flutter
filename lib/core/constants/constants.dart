...
const String currentUserIdKey = 'userId'; 
const String currentUsernameKey = 'username'; 
const String currentUserEmailKey = 'email'; 
const String api = 'https://10.0.2.2:7128/api';
